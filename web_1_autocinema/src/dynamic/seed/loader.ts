function getApiBaseUrl(): string {
  if (typeof window !== "undefined") {
    return process.env.NEXT_PUBLIC_API_URL || "https://api-benchmark.autoppia.com/webs-server";
  }
  return process.env.API_URL || "https://api-benchmark.autoppia.com/webs-server";
}
