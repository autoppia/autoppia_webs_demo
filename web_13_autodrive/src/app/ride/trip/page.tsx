      ...
      <section className="flex-1 max-w-2xl max-lg:max-w-full">
        ...
        <div className="space-y-3">
          {rides.map((ride, idx) =>
            ...
            className={
              `flex items-center gap-4 rounded-xl px-6 py-5 cursor-pointer transition${selectedRideIdx === idx
              ...
              onClick={() => {
                ...
                if (rideToReserve && selectedRideIdx !== null) {
                  ...
                  const reserveRideEventData = {
                    ...
                    discountPercentage: ((rideToReserve.oldPrice - rideToReserve.price) / rideToReserve.oldPrice * 100).toFixed(2),
