...
export function DynamicLayout({ textStructure }: DynamicLayoutProps) {
    ...
    case 1: // Classic Gmail
      return (
        <div className={cn("h-screen flex flex-col bg-background", currentVariant.styles.container)} suppressHydrationWarning>
          <Toolbar onMenuClick={toggleSidebar} textStructure={textStructure} />
          <div className="flex flex-1 overflow-hidden">
            <div className={cn(
              ...
              <Sidebar textStructure={textStructure} />
            </div>
            {sidebarOpen && (
            ...
            <div className="flex-1 flex overflow-hidden">
              {currentEmail ? (
                <div className="flex-1">
                  <EmailView textStructure={textStructure} />
                </div>
              ) : (
                <div className="flex-1">
                  <EmailList textStructure={textStructure} />
                </div>
              )}
            </div>
          </div>
          <ComposeModal textStructure={textStructure} />
        </div>
      );
