...
is_valid_demo() {
  case "$1" in
    movies|autocinema|books|autobooks|autozone|autodining|autocrm|automail|autodelivery|autolodge|autoconnect|autowork|autocalendar|autolist|autodrive|autohealth|autochess|all)
      return 0
      ;;
    *)
      return 1
