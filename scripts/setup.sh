...
setup_docker() {
  ...
  if [ "$FAST_MODE" = true ]; then
    ...
    if [ "$CLEAN_ALL" = true ]; then
      ...
      local project_prefixes="webs_server movies_ books_ autozone_ autodining_ autocrm_ automail_ autodelivery_ autolodge_ autoconnect_ autowork_ autocalendar_ autolist_ autodrive_ autohealth_ autodiscord_"
