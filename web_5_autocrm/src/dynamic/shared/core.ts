...
import { isV3Enabled, isV2Enabled, isV1Enabled, isV4Enabled } from "./flags";
...
export function useDynamicSystem() {
  ...
  return useMemo(() => ({
    ...
    v1: {
       ...
       *
       * @param componentKey - Unique component identifier (e.g. "matter-card", "search-button")
       ...
       * @param key - Unique identifier (e.g. "stats-cards", "sidebar-nav")
    ...
    v2: {
      /**
       * Check if V2 is enabled (either V2 or enabled)
       */
    ...
    v3: {
       ...
       *   dyn.v3.getVariant("dashboard_title", dynamicV3TextVariants)  // Local texts
       */
      getVariant: (
        key: string,
