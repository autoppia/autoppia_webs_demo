    ...
    <main>
      <nav className="w-full border-b bg-white sticky top-0 z-10">
        <div className="max-w-6xl mx-auto flex items-center justify-between h-20 px-4 gap-2">
          ...
          <div className="flex items-center gap-4">
            <Link className="text-sm text-gray-600 hover:text-[#c24742]" href="/help">Get help</Link>
            <Link className="text-sm text-gray-600 hover:text-[#c24742]" href="/faqs">FAQs</Link>
          </div>
        </div>
      </nav>
      <div className="max-w-2xl mx-auto px-4 pb-10 pt-4">
        ...
        <div className="flex items-center gap-3 mb-6">
          <img src={imageUrl} alt={restaurantName} className="w-16 h-16 rounded-lg object-cover border" />
      ...
      />
        ...
        <div className="text-xs text-gray-600 mt-3">
          ...
          <Link href="#" className="text-[#c24742] underline">OpenDinning Terms of Use</Link>{' '}
          and{' '}
          <Link href="#" className="text-[#c24742] underline">Privacy Policy</Link>.
