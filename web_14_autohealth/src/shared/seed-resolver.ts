...
function getEnabledFlagsInternal(): { v1: boolean; v2: boolean; v3: boolean } {
  ...
  return {
    ...
    v2:
      boolFromEnv(process.env.NEXT_PUBLIC_ENABLE_DYNAMIC_V2_DB_MODE) ||
...
function resolveSeedsLocal(
  ...
  if (flags.v2) {
    resolved.v2 = safeSeed; // V2: usar seed base directamente (sin derivación)
  }
  if (flags.v3) {
