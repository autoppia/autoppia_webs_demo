...
export const EVENT_TYPES = {
  ...
  // VIEW_APPOINTMENT: "VIEW_APPOINTMENT",  //additional
  // CANCEL_APPOINTMENT: "CANCEL_APPOINTMENT",  //additional
  // RESCHEDULE_APPOINTMENT: "RESCHEDULE_APPOINTMENT",   //additional
  ...
  // DOWNLOAD_PRESCRIPTION: "DOWNLOAD_PRESCRIPTION", //additional
  
  // Doctor Events
  VIEW_DOCTOR_PROFILE: "VIEW_DOCTOR_PROFILE",
  CONTACT_DOCTOR: "CONTACT_DOCTOR",
  VIEW_REVIEWS_CLICKED: "VIEW_REVIEWS_CLICKED",
  // SEARCH_DOCTORS: "SEARCH_DOCTORS", //additional
  // FILTER_DOCTORS: "FILTER_DOCTORS", //additional
  ...
  // LOGOUT: "LOGOUT", //additional
  // VIEW_PROFILE: "VIEW_PROFILE", //additional
  // UPDATE_PROFILE: "UPDATE_PROFILE", //additional
  
  // Search and Filter Events
  // SEARCH_MEDICAL_RECORDS: "SEARCH_MEDICAL_RECORDS",  //additional
  // FILTER_BY_DATE: "FILTER_BY_DATE",  //additional
  FILTER_BY_SPECIALTY: "FILTER_BY_SPECIALTY",
  
  // Health Data Events
  UPLOAD_HEALTH_DATA: "UPLOAD_HEALTH_DATA",
  VIEW_HEALTH_METRICS: "VIEW_HEALTH_METRICS",
  // EXPORT_HEALTH_DATA: "EXPORT_HEALTH_DATA",  //additional
