...
class UserDetailView(LoginRequiredMixin, DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        create_event(
            user=request.user,
            event_type=Web2EventNames.USER_VIEW,
            description=f"User {request.user.username} viewed their profile",
            data={"username": request.user.username},
            web_agent_id=request.headers.get("X-Miner-Id", None),
        )
...
class UserUpdateView(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        create_event(
            ...
            event_type=Web2EventNames.USER_UPDATE,
...
class UserRedirectView(LoginRequiredMixin, RedirectView):
    ...
    def get_redirect_url(self):
        ...
        create_event(
            user=self.request.user,
            event_type=Web2EventNames.USER_REDIRECT,
