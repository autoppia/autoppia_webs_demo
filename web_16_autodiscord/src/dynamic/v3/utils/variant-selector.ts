...
export const ID_VARIANTS_MAP: Record<string, string[]> = idVariantsJson as Record<string, string[]>;
export const CLASS_VARIANTS_MAP: Record<string, string[]> = classVariantsJson as Record<string, string[]>;
...
export function getVariant(
  ...
  if (variants && key in variants) {
    ...
    selectedVariants =
      ID_VARIANTS_MAP[key] || CLASS_VARIANTS_MAP[key] || TEXT_VARIANTS_MAP[key];
  }
  ...
  if (seed === 1) return selectedVariants[0];
