...
export function isV1Enabled(): boolean {
  ...
  if (typeof window !== "undefined" && process.env.NODE_ENV === "development") {
    if (!enabled) {
      console.warn("[dynamic] V1 is disabled. To enable, set NEXT_PUBLIC_ENABLE_DYNAMIC_V1=true");
    }
  }
...
export function isV2Enabled(): boolean {
  ...
  if (typeof window !== "undefined" && process.env.NODE_ENV === "development") {
    if (!enabled) {
      console.warn("[dynamic] V2 is disabled. To enable, set NEXT_PUBLIC_ENABLE_DYNAMIC_V2=true");
    }
  }
...
export function isV3Enabled(): boolean {
  ...
  if (typeof window !== "undefined" && process.env.NODE_ENV === "development") {
    if (!enabled) {
      console.warn("[dynamic] V3 is disabled. To enable, set NEXT_PUBLIC_ENABLE_DYNAMIC_V3=true");
    }
  }
