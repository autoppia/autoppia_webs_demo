...
const MIN_REQUIREMENTS = {
  v1AddWrapDecoy: 18,      // Minimum addWrapDecoy usages
  v1ChangeOrder: 4,        // Minimum changeOrderElements usages
  v3Ids: 22,               // Minimum getVariant with ID_VARIANTS_MAP usages
  v3Classes: 15,           // Minimum getVariant with CLASS_VARIANTS_MAP usages
  v3Texts: 20,             // Minimum getVariant for texts usages
...
// ============================================================================
// TEST V2: Dataset variation (integration test, strict by default)
// ============================================================================

function testV2DatasetVariation() {
  console.log('\n🗃️  TEST V2: Variación de dataset (integración)');
  ...
  function buildUrl(seed) {
    ...
    const params = new URLSearchParams({
      project_key: 'web_11_autocalendar',
  ...
  if (unique.size >= 2) {
    console.log(`   ✅ Variación detectada: ${unique.size}/${seedsToTest.length} resultados distintos (por top-10 id/label)`);
    results.passed++;
  } else {
...
// ============================================================================
// TEST 4: Uso en DOM (browser-only)
// ============================================================================
