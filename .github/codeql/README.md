...
- **To stop path-injection alerts:** In the repo go to **Security → Code scanning → CodeQL analysis → Edit** (or “View CodeQL configuration”) and add a **query filter** to exclude the query id `py/path-injection`.
