...
/** Above HeaderNav (z-30) and BottomNav (z-40) so overlay blocks nav and is always visible. */
...
function getPlacementStyle(placement: string): React.CSSProperties {
  switch (placement) {
    case "bottom-right":
      return { position: "fixed" as const, bottom: 88, right: 24, left: "auto", top: "auto" };
    case "bottom-left":
      return { position: "fixed" as const, bottom: 88, left: 24, right: "auto", top: "auto" };
    case "banner":
      return { position: "fixed" as const, bottom: 88, left: "50%", right: "auto", top: "auto", transform: "translateX(-50%)" };
    case "top-right":
