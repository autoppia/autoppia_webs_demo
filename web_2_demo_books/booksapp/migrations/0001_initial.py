    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "genres",
                    models.ManyToManyField(blank=True, related_name="movies", to="movieapp.genre"),
                ),
            ],
            options={
                "ordering": ["-created_at"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "favorite_genres",
                    models.ManyToManyField(blank=True, related_name="user_favorites", to="movieapp.genre"),
                ),
                (
                    "user",
