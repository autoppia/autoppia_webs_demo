"""
Seeded data loader for web_2_demo_books (Django).
...
def load_books_from_api(seed_value: Optional[int] = None, limit: int = 100) -> List[Dict[str, Any]]:
    """
    Load books from webs_server API using v2-seed.
    ...
    books = fetch_seeded_selection(
        entity_type="books",
        seed_value=effective_seed,
        limit=limit,
        method="distribute",
        filter_key="genres",  # Distribute by genres if available
    )
