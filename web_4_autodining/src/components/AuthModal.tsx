...
export function AuthModal() {
  ...
  if (isAuthenticated && currentUser) {
    return (
      <div className="p-4 w-64 bg-white rounded-lg shadow-xl border">
  ...
  return (
    <div className="p-6 w-80 bg-white rounded-lg shadow-2xl border">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-gray-900"
