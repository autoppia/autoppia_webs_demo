    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center max-w-md px-4">
          ...
          <SeedLink
            href="/"
            className="inline-flex rounded-full border border-red-200 px-6 py-3 text-sm font-medium text-red-700 hover:bg-red-50 transition-colors"
          >
            Back to home
          </SeedLink>
        </div>
    ...
    dyn.v1.addWrapDecoy("restaurant-detail-page", (
      ...
      >
        ...
        >
          ...
          {(r?.tags || []).length > 0 && (
            ...
            >
              {(r?.tags || []).map((tag: string, index: number) => (
                <span
                  key={tag}
                  className="inline-flex items-center py-1.5 px-4 bg-red-50 rounded-full text-red-700 font-semibold text-sm border border-red-200 whitespace-nowrap"
          ...
          {dyn.v1.addWrapDecoy("menu-section", (
                ...
                >
                  ...
                  >
                    <div
                      className="flex gap-6 border-b border-gray-200 mb-6 pb-2"
                      id={dyn.v3.getVariant("menu-tabs", ID_VARIANTS_MAP, "menu-tabs")}
                    >
                      <button
                        className="border-b-2 border-[#dc2626] text-[#dc2626] font-semibold px-4 py-2 -mb-px bg-white"
              ...
              <div className="space-y-8">
                ...
                <div className="flex justify-center pt-4">
                  {dyn.v1.addWrapDecoy("menu-toggle-button", (
                    <Button
                      className={dyn.v3.getVariant("button-secondary", CLASS_VARIANTS_MAP, "border-2 border-red-200 px-8 py-2.5 rounded-lg font-semibold bg-white hover:bg-red-50 text-red-700 transition-colors")}
                ...
                >
                  ...
                  >
                    {dyn.v1.addWrapDecoy("info-card-cuisine", (
                      <div
                        className="bg-gradient-to-br from-white to-red-50 rounded-xl p-5 border-2 border-gray-200"
          ...
          <section className="w-full mb-10" id="reviews-section">
            ...
            <div
              className="bg-white border-[3px] border-red-200 rounded-xl p-8 mb-8 shadow-sm flex flex-col md:flex-row items-center md:items-start gap-8"
            ...
            >
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="mt-4 flex flex-wrap justify-center md:justify-start gap-4">
                  <div className="px-3 py-1 bg-red-50 rounded text-xs font-bold text-red-700 uppercase tracking-tighter">
                    {`${r?.reviews ?? 305} Total reviews`}
                  </div>
                  <div className="px-3 py-1 bg-red-100 rounded text-xs font-bold text-red-700 uppercase tracking-tighter">
            ...
            {isAuthenticated ? (
              <div className="bg-white border-[3px] border-red-200 rounded-xl p-6 shadow-sm mb-8" id="review-form">
                ...
                <form onSubmit={handleReviewSubmit} className="space-y-4">
                  ...
                  <textarea
                    ...
                    className="w-full p-4 border border-red-200 rounded-xl bg-white focus:ring-2 focus:ring-red-500 outline-none text-gray-900 min-h-[100px] transition-all"
                    required
                  />
              ...
              <div className="bg-red-50 border-[3px] border-red-200 rounded-xl p-6 text-center mb-8">
                <p className="text-gray-700">Please sign in to leave a review.</p>
              </div>
            )}
            ...
            <div className="space-y-6">
              {reviews.length === 0 ? (
                <div className="bg-white border-[3px] border-red-200 rounded-xl p-8 text-center shadow-sm">
                  <Star className="w-12 h-12 text-red-200 mx-auto mb-3" />
                  <p className="text-gray-700 text-lg">No reviews yet. Be the first to write one!</p>
                </div>
              ) : (
                reviews.map((review) => (
                  <div
                    key={review.id}
                    className="bg-white border-[3px] border-red-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow relative group"
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="flex items-center bg-red-50 px-2 py-1 rounded-lg border border-red-100">
              ...
              {reviews.length > 0 && (
                <div className="bg-red-50 rounded-xl p-4 border border-dashed border-red-200">
                  <p className="text-xs text-center text-red-700 uppercase tracking-widest font-bold">
        ...
        {dyn.v1.addWrapDecoy("booking-widget", (
          <div
            className="rounded-xl border-[3px] border-red-200 bg-white shadow-lg p-6 w-full max-w-sm md:sticky md:top-8 self-start"
              ...
              >
                <PopoverTrigger asChild>
                  <Button
                    ...
                    variant="outline"
                    className="w-full flex items-center justify-between border-red-200 hover:border-[#dc2626]"
                  >
