  ...
  return (
    <>
      <section className={`py-5 md:py-5 bg-white rounded-xl shadow-md mb-12 flex flex-col items-center text-center ${layout.hero.containerClass}`}>
        <h1 className={`text-2xl md:text-4xl font-extrabold mb-4 tracking-tight text-zinc-900 ${layout.hero.titleClass}`}>
          Delicious food,
          <br /> delivered to your door
        </h1>
        <p className={`text-lg mb-8 max-w-xl text-zinc-600 ${layout.hero.descriptionClass}`}>
